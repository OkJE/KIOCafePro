...
<div class="swiper mySwiper">
	...
	<div class="swiper-wrapper">
		...
		<a href="${pageContext.request.contextPath}/view/category/categoryDetailForm.jsp">
		<img alt="#" src="./img/1.png" ></a>
			<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <div class="swiper-slide"><img alt="#" src="./img/2.png">
        	<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <div class="swiper-slide"><img alt="#" src="./img/3.png">
        	<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <div class="swiper-slide"><img alt="#" src="./img/4.png">
        	<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <div class="swiper-slide"><img alt="#" src="./img/5.png">
        	<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<div class="benner w3-teal">
	...
	<div class="swiper mySwiper2">   
		<div class="swiper-wrapper">
			<div class="swiper-slide"><img alt="#" src="./img/6.png">
			 <table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				    <td class="w3-teal"> Slide 6</td>
			...
			<div class="swiper-slide"><img alt="#" src="./img/7.png">
				<table>
			  	<tr> <td> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				    <td class="w3-teal"> Slide 7</td>
