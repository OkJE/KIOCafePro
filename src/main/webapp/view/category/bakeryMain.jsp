            ...
            <div class="section">
                ...
                <div class="slidewrap">
                    <ul class="slidelist">
                        <li class="slideitem">
                            <a>
                                <img src="./img/bread1.png" alt="${pageContext.request.contextPath}/view/category/categoryDetailForm.jsp">
                                <div class="textbox">
                                	<h1>소세지 빵</h1>
                                	<p>아이 어른 할 것 없이 누구나 좋아하는 추억의 옛날식 소시지빵</p>
									<p>소시지빵의 최강자! 파바의 스테디셀러로 믿고 먹는 제품</p>
                                </div>
                            </a>
                        </li>
                        <li class="slideitem">
